...
if(isset($_POST['submit'])){
    ...
    $result=$conn->query( "INSERT INTO product(product_name,Quantity,quality) VALUE('$product_name','$Quantity','$quality')" );
    ...
    <div class="container">
        ...
        <div class="content-left">
            <div class="input">
                ...
                <input type="submit" class="btn" name="submit" value="add product"><br><br>
