...
if(isset($_POST['submit'])){
    ...
    $update=$conn->query("UPDATE product SET product_name='$product_name',Quantity='$Quantity' WHERE product_id='$id'");
    if($update){
    ...
    <div class="container">
        ...
        <div class="content-left">
            <div class="input">
                ...
                <h1>edit  product</h1>
                <?php 
                $info=$conn->query("SELECT * FROM product WHERE product_id='$id'");
                foreach ($info as $row) {
                ...
                <input type="text" value='<?= $pname ?>' class="form-control" name="product_name" required><br>
                </div>
